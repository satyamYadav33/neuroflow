...
// GET /api/features — Returns 3 AI features
...
// POST /api/contact — Accepts name, email, message. Logs to console.
...
app.listen(PORT, () => {
    console.log(`\n⚡ Neuroflow API server running at http://localhost:${PORT}\n`);
    console.log('  Endpoints:');
    console.log('    GET  /api/features  — AI feature list');
